...
const STRINGS = {
  ...
  navProjects: ["Проєкти","Projekty"],
  newProjectBtn: ["+ НОВИЙ ПРОЄКТ","+ NOVÝ PROJEKT"],
  newProjectTitle: ["НОВИЙ ПРОЄКТ","NOVÝ PROJEKT"],
  fieldProjectName: ["Назва проєкту","Název projektu"],
  projectNamePh: ["Напр. Офіс Linaro, вул. Х","Např. Kancelář Linaro, ul. X"],
  fieldProjectAddress: ["Адреса (необов'язково)","Adresa (nepovinné)"],
  projectAddressPh: ["Напр. м. Прага, вул. Х 12","Např. Praha, ul. X 12"],
  fillProjectName: ["Введіть назву проєкту.","Zadejte název projektu."],
  statusActive: ["активний","aktivní"],
  statusDone: ["завершено","dokončeno"],
  closeProjectBtn: ["Завершити","Dokončit"],
  reopenProjectBtn: ["Відновити","Obnovit"],
  deleteProjectBtn: ["🗑 Видалити проєкт","🗑 Smazat projekt"],
  confirmDeleteProject: ["Видалити проєкт разом з усіма його записами? Це незворотно.","Smazat projekt včetně všech záznamů? Nelze vrátit zpět."],
  emptyProjects: ["Активних проєктів ще немає.","Zatím žádné aktivní projekty."],
  backToProjects: ["← Усі проєкти","← Všechny projekty"],
  activeProjectsTitle: ["Активні","Aktivní"],
  doneProjectsTitle: ["Завершені","Dokončené"],
  needActiveProject: ["Спочатку створіть проєкт, щоб додавати записи.","Nejprve vytvořte projekt pro přidávání záznamů."],
  entriesCountLabel: ["записів","záznamů"],
